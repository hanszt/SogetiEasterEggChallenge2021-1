...
import static nl.sogeti.model.AppConstants.SOGETI_BLUE;

public class SogetiLogo extends Group {

    public SogetiLogo() {
        Group sogetiLogo = buildSogetiLogo();
        Group capgeminiLogo = buildCapgeminiLogo();

        sogetiLogo.setOnMouseClicked(this::goToSogetiSite);
        capgeminiLogo.setOnMouseClicked(this::goToCapgeminiSite);
        getChildren().addAll(sogetiLogo, capgeminiLogo);
    }

    @NotNull
    private Group buildSogetiLogo() {
        SVGPath sogetiLetters = new SVGPath();
        sogetiLetters.setContent(SOGETI_LOGO_SVG);
        sogetiLetters.setFill(SOGETI_BLUE);
        SVGPath sogetiDot = new SVGPath();
        sogetiDot.setContent(SOGETI_DOT);
        sogetiDot.setFill(Color.web("#FF4019"));
        sogetiDot.setOnMouseClicked(this::goToEasterEgg);
        return new Group(sogetiLetters, sogetiDot);
    }


    private static final Random RANDOM = new Random();

    public void goToEasterEgg(MouseEvent event) {
        List<String> urls = List.of("https://elgoog.im/pacman/",
                "https://elgoog.im/pacman/",
                "https://elgoog.im/space-invaders/",
                "https://elgoog.im/goooooooooooooooooogle/",
        ...
        application.getHostServices().showDocument(urls.get(RANDOM.nextInt(urls.size())));
        event.consume();
    }

    @NotNull
    private Group buildCapgeminiLogo() {
        SVGPath capgeminiLogoDark = new SVGPath();
        capgeminiLogoDark.setContent(CAPGEMINI_LOGO_DARK);
        capgeminiLogoDark.setFill(SOGETI_BLUE);
        SVGPath capgeminiLogoLight = new SVGPath();
        capgeminiLogoLight.setContent(CAPFEMINI_LOGO);
        capgeminiLogoLight.setFill(Color.web("#12ABDB"));
        SVGPath partOf = new SVGPath();
        partOf.setContent(PART_OF);
        partOf.setFill(SOGETI_BLUE);
        return new Group(partOf, capgeminiLogoDark, capgeminiLogoLight);
    }

    private void goToSogetiSite(MouseEvent event) {
        Application application = new Application() {
            @Override
            public void start(Stage stage) {
                //This new instance is to refer to the browser
        ...
        application.getHostServices().showDocument("https://www.sogeti.com/");
        event.consume();
    }

    private void goToCapgeminiSite(MouseEvent event) {
        Application application = new Application() {
            @Override
            public void start(Stage stage) {
                //This new instance is to refer to the browser
        ...
        application.getHostServices().showDocument("https://www.capgemini.com/");
        event.consume();
    }

    private static final String CAPFEMINI_LOGO = "M397.2,186.5c6.1,0,10.9-5,11-11c-0.4-2.6-1.3-7.4-8.1-7.4c-7.4,0-9.8,10.3-15.8,16.9" +
    ...
    private static final String CAPGEMINI_LOGO_DARK = "M350,170.1c0-3.3-0.2-5.5-2.3-5.5c-1,0-1.4,0.2-2.3,0.5c0.8,11-1.7,20.8-4.8,20.8c-4,0-2-23.7-10.5-23.7" +
            ...
            "M303,159.7c1.8-0.1,3-1.6,3.1-3.4c0-1.8-1.2-3.3-3-3.2c-1.8,0.1-3.3,1.6-3.3,3.4" +
            "C299.8,158.3,301.3,159.8,303,159.7z" +

            "M347.6,160.6c1.6-0.1,3-1.5,3-3.3c0-1.7-1.3-3.1-2.9-3.1c-1.6,0.1-3,1.5-3,3.3" +
            "C344.7,159.3,346,160.7,347.6,160.6z" +

            "M408.2,175.1c-0.1-6.9-3.4-12.7-8.5-17.4c-3.8-3.5-8.4-6.2-13.2-8.2c-0.4-0.2-0.8-0.3-1.2-0.5l0,0" +
    ...
    private static final String PART_OF = "M48.7,168.8c2.6,0,4.6,0.5,5.9,1.4c1.4,0.9,2.1,2.4,2.1,4.4c0,1-0.2,1.9-0.5,2.7c-0.4,0.7-0.9,1.4-1.6,1.8" +
            ...
            "M62.6,173c1,0,1.9,0.1,2.6,0.4c0.7,0.3,1.3,0.6,1.7,1.1c0.4,0.5,0.7,1,0.9,1.7c0.2,0.7,0.3,1.4,0.3,2.2v8.1" +
            ...
            "M77.6,176.2c-0.3-0.1-0.6-0.2-1.1-0.3c-0.5-0.1-1-0.1-1.6-0.1c-0.3,0-0.7,0-1.1,0.1c-0.4,0.1-0.7,0.1-0.8,0.2" +
            ...
            "M79.5,169.8l3.1-0.5v4h4.8v2.6h-4.8v5.5c0,1.1,0.2,1.8,0.5,2.3s0.9,0.7,1.7,0.7c0.6,0,1.1-0.1,1.5-0.2" +
            ...
            "M107.4,180.1c0,1.1-0.2,2-0.5,2.9c-0.3,0.9-0.7,1.6-1.3,2.2c-0.6,0.6-1.2,1.1-2,1.4c-0.8,0.3-1.7,0.5-2.6,0.5" +
            ...
            "M114.5,166.9c0.7,0,1.3,0.1,1.9,0.2c0.5,0.1,1,0.2,1.2,0.3L117,170c-0.3-0.1-0.6-0.2-1-0.3" +
    ...
    private static final String SOGETI_DOT = "M408.6,12.8c0,3.8-1.2,6.8-3.7,9c-2.5,2.2-5.4,3.3-8.7,3.3c-3.5,0-6.4-1.1-8.9-3.3s-3.7-5.2-3.7-9" +
            "c0-3.9,1.2-7,3.7-9.2s5.4-3.3,8.9-3.3c3.3,0,6.2,1.1,8.7,3.4S408.6,8.9,408.6,12.8z";

    private static final String SOGETI_LOGO_SVG = "M334.9,13.9l11.5-1.9l0,26.4l31.1,0l0,7.9c0,5-4,9-9,9l-22.1,0l0,35.6c0,7,1.1,12.1,3.3,15.1" +
            ...
            "M406.3,125.9l-5.7,0c-8.1,0-14.6-6.5-14.6-14.6l0-72.9l6.9,0c7.4,0,13.4,6,13.4,13.4L406.3,125.9z" +

            "M239,82.7c0-7.7,1.1-14.4,3.4-20.2c2.3-5.8,5.3-10.6,9.1-14.4c3.8-3.8,8.1-6.7,13-8.7c4.9-1.9,9.9-2.9,15-2.9" +
            ...
            "M152.4,82c0,6.9-1,13.2-2.9,18.9c-1.9,5.7-4.7,10.5-8.3,14.6c-3.6,4-7.8,7.1-12.9,9.4" +
            ...
            "M65.3,92.5c-1-2.8-2.6-5.3-4.8-7.4c-2.2-2.2-4.9-4.1-8.3-5.9c-3.3-1.7-7.4-3.5-12.2-5.3c-2.9-1-5.4-2-7.4-2.9" +
            ...
            "M217.9,38c-5.7-1-11.7-1.5-18-1.5c-6.5,0-12.4,1.1-17.5,3.2c-5.1,2.1-9.5,5.1-13.1,8.9" +
